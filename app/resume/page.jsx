          ...
          <div className="min-h-[70hv] w-full">
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <p className="text-white/60">{item.compony}</p>
                          </div>
                        </li>
                      );
                    })}
            ...
            >
              <div className="flex flex-col gap-[30px]">
                ...
                <ul className="grid grid-cols-1 xl:gris-cols-2 gap-y-6 max-w-[620px] mx-auto xl:mx-0">
